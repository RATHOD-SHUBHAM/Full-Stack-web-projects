...
import { getAProducts, getAllCategory, updateProduct } from '../../admin/helper/adminapicall'
...
const UpdateProduct = ({match}) => {
    ...
    const preloadCategories = () => {
        // admin => helper => getAllCategory
        // just call and once you receive data check if you are receiveing a error
        // if not load into array
        getAllCategory()
        .then(data => {
            console.log("the data is : ",data);
            // if data.error = will give a error saying it cant read property error
    ...
    useEffect(() => {
        preload(match.params.productId); // eslint-disable-next-line
    }, []);
